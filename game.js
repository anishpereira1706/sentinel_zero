...
const ASSETS = {
    ...
    bgProps: ASSET_BASE + 'Background/Background%20Props.png',
    baseColor: ASSET_BASE + 'Background/Base%20Color.png',
    frontalFog: ASSET_BASE + 'Background/Frontal%20Fog.png',
    midFog: ASSET_BASE + 'Background/Mid%20Fog.png',
    // Player sprite sheets (Case-Sensitive for Vercel/Linux)
    playerIdle: ASSET_BASE + 'Player/PlayerIdle.png',
    playerRun: ASSET_BASE + 'Player/PlayerRun.png',
    playerJump: ASSET_BASE + 'Player/PlayerJump.png',
    playerFall: ASSET_BASE + 'Player/PlayerFall.png',
    playerDash: ASSET_BASE + 'Player/PlayerDash.png',
    playerDeath: ASSET_BASE + 'Player/PlayerDeath.png',
    // New enemy sprite sheets (Enemies_2)
    goblinAttack: ASSET_BASE + 'Enemies_2/Goblin/Attack3.png',
    goblinBomb: ASSET_BASE + 'Enemies_2/Goblin/Bomb_sprite.png',
    mushroomAttack: ASSET_BASE + 'Enemies_2/Mushroom/Attack3.png',
    mushroomProjectile: ASSET_BASE + 'Enemies_2/Mushroom/Projectile_sprite.png',
    skeletonAttack: ASSET_BASE + 'Enemies_2/Skeleton/Attack3.png',
    skeletonSword: ASSET_BASE + 'Enemies_2/Skeleton/Sword_sprite.png',
    flyingEyeAttack: ASSET_BASE + 'Enemies_2/Flying%20eye/Attack3.png',
    flyingEyeProjectile: ASSET_BASE + 'Enemies_2/Flying%20eye/projectile_sprite.png',
};
